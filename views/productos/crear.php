...
<form style="align-content:center;" action="<?=$url_action?>" method="POST" enctype="multipart/form-data">
    ...
    <?php if(isset($pro) && is_object($pro) && !empty($pro->imagen)):?>
        <img style="height:215px; margin-left:25px;" src="<?=base_url?>uploads/images/<?=$pro->imagen?>"/>
    <?php endif; ?>
